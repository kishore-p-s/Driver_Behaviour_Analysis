...
def parametersCalculation():
    ...
    while True:
        ...
        db.collection("sensor_data").document("ear").set({"value":earCalculation.ear_val})
        db.collection("sensor_data").document("acceleration").set({"value": acc})
        db.collection("sensor_data").document("brake").set({"value": brake})
        db.collection("sensor_data").document("seatbelt").set({"value": seatbelt})
        db.collection("sensor_data").document("bpm").set({"value": bpm})
        db.collection("sensor_data").document("voice").set({"value": voice})
        db.collection("sensor_data").document("steering").set({"value": steering})
        db.collection("sensor_data").document("left_in").set({"value": left_in})
        db.collection("sensor_data").document("right_in").set({"value": right_in})
        db.collection("sensor_data").document("headlight").set({"value": headlightin})
        db.collection("sensor_data").document("gear").set({"value": gear})
        db.collection("sensor_data").document("cornering").set({"value": cornering})
        db.collection("sensor_data").document("sudden break").set({"value": sudden_break})
        db.collection("sensor_data").document("horn").set({"value": horn})
        time.sleep(1)
